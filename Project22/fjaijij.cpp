...
char WesternFoodOrdering(string);
...
{	// Define arrays for food items
	...
	cout << "*************************************************************************" << endl;
	do {
		cout << "\tWelcome to our restaurant. You can ordering by selecting " << endl;
				...
				if (option2 == 'F' || option2 == 'f')
				{
					...
					else if (option3 == "LF" || option3 == "lf")
					{
						...
						do {
							...
							for (int i = 0; i < 5; ++i)
							{
								cout << i + 1 << ": " << localFood[i].name << " (" << localFood[i].code << ") - RM " << westernFood[i].price << endl;
							}
							cin >> option5;
